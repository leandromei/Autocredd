...
async def get_environment():
    ...
    return {
        ...
        "frontend_exists": FRONTEND_DIR.exists() and (FRONTEND_DIR / "index.html").exists(),
        "evolution_url": EVOLUTION_API_URL
    }

# === WHATSAPP INTEGRATION (MOVED ENDPOINTS) ===
...
# === SPA ROUTING PARA FRONTEND ORIGINAL (DEVE SER A ÚLTIMA ROTA!) ===
@app.get("/{path:path}")
